...
<div class="wrapper">
	...
	<div class="article-details">
			...
			<div class="item-content">
				...
				<div class="item-images">
					<div class="featured-img-container">
						...
						<img src="/img/content/fish/fish.jpg" alt="Fish Food" class="featured-img">
					</div>
					<div class="img-list">
						<section id="img-list-1" class="active">
							<img src="/img/content/fish/fish.jpg" alt="Fish Food">
							<figcaption>A hungry fish</figcaption>
						</section>
						<section id="img-list-2">
							<img src="/img/content/fish/fish.jpg" alt="Fish Food">
							<figcaption>is a sad fish</figcaption>
						</section>
				...
				<div class="item-description">
					...
					<div class="breadcrumb">
						...
						<div class="dot fish"></div>
						<div class="arrow-left"></div><span>Fish</span>
						<div class="arrow-left"></div><span>Splash 'n Fun</span>
					</div>
					
					<!-- Item Text -->
					<h1 class="uppercase heading h-l">Fish Food</h1>
					<h2 class="uppercase heading h-ml font-txt weight-bold">&euro; 2,49</h1>
					<!-- Colours -->
		...
		<div class="related-products">
			...
			<a href="/fish" class="txt-l">view more</a>
		</div>
