...
<div class="wrapper">
	...
	<div class="article-details">
			...
			<div class="item-content">
				...
				<div class="item-images">
					<div class="featured-img-container">
						...
						<img src="/img/content/cats/cat.jpg" alt="Cooling mat for a cat" class="featured-img">
					</div>
					<div class="img-list">
						<section id="img-list-1" class="active">
							<img src="/img/content/cats/cat.jpg" alt="Cooling mat for a cat">
							<figcaption>A cool cat is</figcaption>
						</section>
						<section id="img-list-2">
							<img src="/img/content/cats/cat-thumbnail.jpg" alt="Cooling mat for a cat">
							<figcaption>a happy cat</figcaption>
						</section>
						<section id="img-list-3">
							<img src="/img/content/cats/cooling-mat-detail.jpg" alt="Cooling mat for a dog">
				...
				<div class="item-description">
					...
					<h2 class="uppercase heading h-ml font-txt weight-bold">&euro; 12,49</h1>
					<!-- Colours -->
		...
		<div class="related-products">
			...
			<a href="/cats" class="txt-l">view more</a>
		</div>
