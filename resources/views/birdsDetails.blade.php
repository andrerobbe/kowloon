			...
			<div class="item-content">
				...
				<div class="item-images">
					<div class="featured-img-container">
						...
						<img src="/img/content/birds/cage.jpg" alt="Cage of a bird" class="featured-img">
					</div>
					<div class="img-list">
						<section id="img-list-1" class="active">
							<img src="/img/content/birds/cage.jpg" alt="Cage of a bird">
							<figcaption>An egg is</figcaption>
						</section>
						<section id="img-list-2">
							<img src="/img/content/birds/bird.jpg" alt="eggs">
							<figcaption>an egg</figcaption>
						</section>
						<section id="img-list-3">
							<img src="/img/content/birds/cage-details.jpg" alt="Cage of a bird">
				...
				<div class="item-description">
					...
					<div class="breadcrumb">
						...
						<div class="dot bird"></div>
						<div class="arrow-left"></div><span>Birds</span>
						<div class="arrow-left"></div><span>Caught 'n Screwed</span>
					</div>
					
					<!-- Item Text -->
					<h1 class="uppercase heading h-l">Bird's Cage</h1>
					<h2 class="uppercase heading h-ml font-txt weight-bold">&euro; 27,49</h1>
					<!-- Colours -->
