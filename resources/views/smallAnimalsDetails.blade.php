...
<div class="wrapper">
	...
	<div class="article-details">
			...
			<div class="item-content">
				...
				<div class="item-images">
					<div class="featured-img-container">
						...
						<img src="/img/content/hamster/cage.jpg" alt="Cage for a hamster" class="featured-img">
					</div>
					<div class="img-list">
						<section id="img-list-1" class="active">
							<img src="/img/content/hamster/cage.jpg" alt="Cage for a hamster">
							<figcaption>A happy hamster</figcaption>
						</section>
						<section id="img-list-2">
							<img src="/img/content/hamster/cage-details.jpg" alt="Cage for a hamster">
							<figcaption>is a running</figcaption>
						</section>
				...
				<div class="item-description">
					...
					<!-- Item Text -->
					<h1 class="uppercase heading h-l">Hamster's Cage</h1>
					<h2 class="uppercase heading h-ml font-txt weight-bold">&euro; 19,49</h1>
					<!-- Colours -->
		...
		<div class="related-products">
			...
			<a href="/small-animals" class="txt-l">view more</a>
		</div>
